...
# dilakukan Vercel sendiri: migrasi skema ke database Neon.
# Jalankan SETELAH Vercel selesai build & deploy.
#
...
#
# Pemakaian:
#   ./scripts/deploy-vercel.sh                 # migrate
...
#     Operasi skema (migrate deploy / db push) memakainya bila ada;
