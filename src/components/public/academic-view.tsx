...
const EKSKUL = [
  { icon: Compass, name: "Pramuka", desc: "Membentuk karakter, kemandirian, dan jiwa kepemimpinan siswa." },
  { icon: Users, name: "OSIS", desc: "Wadah organisasi siswa untuk mengembangkan kreativitas dan kepemimpinan." },
  { icon: Trophy, name: "PMR", desc: "Palang Merah Remaja — pelatihan pertolongan pertama dan kemanusiaan." },
  { icon: GraduationCap, name: "Paskibra", desc: "Pasukan pengibar bendera — disiplin, tangguh, dan cinta tanah air." },
  { icon: FlaskConical, name: "Robotik", desc: "Pengembangan robotika dan teknologi serta kompetisi tingkat nasional." },
  { icon: BookMarked, name: "KIR", desc: "Karya Ilmiah Remaja — riset dan inovasi karya tulis ilmiah siswa." },
  { icon: Globe, name: "English Club", desc: "Meningkatkan kemampuan berbahasa Inggris dan persiapan kompetisi." },
  { icon: Dumbbell, name: "Futsal", desc: "Pengembangan bakat sepak bola dan kompetisi antar sekolah." },
  { icon: Trophy, name: "Basket", desc: "Tim basket putra dan putri yang aktif di kompetisi tingkat kota." },
  { icon: Volleyball, name: "Voli", desc: "Latihan rutin dan kompetisi voli untuk seluruh tingkatan." },
  { icon: PartyPopper, name: "Tari", desc: "Pelestarian dan pengembangan seni tari tradisional dan modern." },
  { icon: Mic, name: "Paduan Suara", desc: "Vokal grup yang tampil di berbagai acara sekolah dan kota." },
];
