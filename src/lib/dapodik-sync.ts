...
// Re-export dari modul hasil ekstraksi C2 — import lama dari
// "@/lib/dapodik-sync" tetap bekerja.
import {
  mapGender,
  parseDate,
  currentAcademicYear,
...
export { getDapodikClient, saveDapodikConfig, getDapodikConfig, testConnection };
